...
const PARAM_DEFS = [
  { code: '43', key: 'cImpresionDirecta', desc: 'Tipo de impresión (A=Activo/Directa, I=Inactivo/GDI, C=Clásica/GDI+ VB)', defaultValue: 'A' },
...
function validate(parsed) {
  ...
  if (p['43'] !== undefined) {
    if (!['A', 'I', 'C'].includes(p['43'].toUpperCase())) {
      errors.push(`cImpresionDirecta (43) inválido: "${p['43']}". Debe ser A, I o C.`);
    }
  }
