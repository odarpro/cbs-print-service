...
:: Lanzar PowerShell para registrar la tarea programada (sin ventana visible)
powershell.exe -NoProfile -ExecutionPolicy Bypass -WindowStyle Hidden -File "%~dp0install-alert-watcher-scheduled.ps1"
